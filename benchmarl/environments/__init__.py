...
from .energy_trading.common import EnergyTradingClass, EnergyTradingTask
from .contract_proposal.common import ContractProposalClass, ContractProposalTask
...
tasks = [VmasTask, Smacv2Task, PettingZooTask, MeltingPotTask, MAgentTask, EnergyTradingTask, ContractProposalTask]
